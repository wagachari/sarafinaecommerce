...
class Hello extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $per_page = 2;
        $config = array();
        $config["base_url"] = base_url() . "friends/hello";
        ...
        $v_data = array(
            "all_friends" => $this->friends_model->get_friend($config["per_page"], $page),
            "page" => $page
        );
        ...
        $data = array(
            ...
            "hello" => $this->friends_model->get_friend($config["per_page"], $page),
        );
